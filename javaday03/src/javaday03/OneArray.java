...
public class OneArray {
	...
	public static void main(String[] args) {
		...
		//데이터 전체를 출력
		//배열이름.length 는 배열 데이터 개수를 정수로 리턴
		...
		//참조형 변수가 생성된 것이지 데이터가 만들어진 것은 어니어서 NullpointException
		/*
		...
		*/
		...
		System.out.println("==================");
		//빠른 열거를 이용한 접근
		//데이터의 시작과 끝을 직접 작성하지 않기 때문에 Index 오류를 일으키지 않는다
